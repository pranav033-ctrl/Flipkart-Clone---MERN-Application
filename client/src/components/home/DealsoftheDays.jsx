...
const DealsOfTheDays = () => {
    return (
        <Wrapper>
            <Box style={{width:220, height:180, marginLeft:'auto',marginRight:'auto',paddingTop:60}}>
                <Typography style={{ fontWeight: 600, fontSize: 28 }}>Deals of <br/>the Day</Typography>
                <Button style={{paddingRight:15,paddingLeft:15,marginTop:10, backgroundColor:'#2874f0', color:'white', fontWeight:600}}>View All</Button>
            </Box>
            <CarouselWrapper>
            <Carousel responsive={responsive} infinite={true}
                ...
                {products.map((product, index) => (
                    <ItemWrapper key={index}>
                        <img src={product.url} alt="product image" style={{ width: 180, height: 180 }} />
